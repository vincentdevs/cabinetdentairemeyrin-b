...
THEMES = {
    # single delivery: the modern rose and cobalt theme, at the site root
    "b1": dict(prefix="", css="b", color="#194D98", preload=["BricolageGrotesque-normal-700.woff2", "DMSans-normal-400.woff2"],
...
S = {
    "fr": dict(
        ...
        visit_h="Un premier rendez-vous chez le dentiste, étape par étape", visit_lead="Beaucoup de personnes repoussent un rendez-vous parce qu’elles ne savent pas ce qui les attend. Voici la consultation étape par étape, de la réservation au devis. Rien n’est décidé à votre place.",
    ...
    "en": dict(
        ...
        visit_h="What happens at a first dental appointment", visit_lead="Many people put off an appointment because they do not know what to expect. Here is the consultation step by step, from booking to the written estimate. Nothing is decided for you.",
